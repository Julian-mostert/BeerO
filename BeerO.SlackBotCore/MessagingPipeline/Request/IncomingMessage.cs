...
namespace BeerO.SlackBotCore.MessagingPipeline.Request
{
    public class IncomingMessage
    {
        ...
        /// Note: this might be empty if the Bot hasn't talked to them privately before, but BeerO.SlackBotCore.SlackBotCore will join the DM automatically if required.
        /// </summary>
        ...
        /// <summary>
        /// Contains the text minus any Bot targetting text (e.g. "@BeerO.SlackBotCore.SlackBotCore: {blah}" turns into "{blah}")
        /// </summary>
        ...
        {
            return ResponseMessage.DirectUserMessage(this.UserId, text);
        }
        ...
        {
            return ResponseMessage.DirectUserMessage(this.UserChannel, this.UserId, string.Empty, new TypingIndicatorMessage());
        }
    }
}