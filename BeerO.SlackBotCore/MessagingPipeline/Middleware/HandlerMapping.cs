...
namespace BeerO.SlackBotCore.MessagingPipeline.Middleware
{
    public class HandlerMapping
    {
        ...
        /// <summary>
        /// Defaults to "True". If set to false then any message is considered, even if it isn't targeted at the bot. e.g. @BeerO.SlackBotCore.SlackBotCore or a private channel
        /// </summary>
